class ObjectStrings {
    ...
    public static final String INIT_PLATINUM_BAR = "On the ground is a large platinum bar.";
    ...
    public static final String INIT_COFFIN = "The solid-gold coffin used for the burial of Ramses II is here.";
