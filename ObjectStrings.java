class ObjectStrings {
    ...
    public static final String DESC_TUBE = "---> Frobozz Magic Gunk Company <---\n"
                                         + "          All-Purpose Gunk";
    ...
    public static final String INIT_MATCHBOOK = "There is a matchbook whose cover says \"Visit Beautiful FCD#3\" here.";
    public static final String INIT_NASTY_KNIFE = "On the table is a nasty-looking knife.";
    ...
    public static final String INIT_TRIDENT = "On the shore lies Poseidon's own crystal trident.";
    public static final String INIT_USELESS = "The deceased adventurer's useless lantern is here.";
    public static final String INIT_ZORK_MANUAL = "Loosely attached to a wall is a small piece of paper.";
    ...
    public static final String CYCLOPS_2 = "A hungry cyclops is standing at the foot of the stairs.";
    public static final String CYCLOPS_EXAMINE = "The cyclops is standing in the corner, eyeing you closely. I don't think he likes you very "
    ...
    public static final String CYCLOPS_DRINK_2 = "The cyclops takes the bottle, checks that it's open, and drinks the water. A moment later, "
    ...
    public static final String CYCLOPS_TRAP_DOOR = "The trap door crashes shut, and you hear someone barring it.";
